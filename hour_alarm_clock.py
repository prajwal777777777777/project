...
try:
    ...
    while True:
        ...
        if((choice=="no" or choice=="n") and (current_time>=12 and current_time<24) and (am_pm=="am")):
        ...
        elif((choice=="no" or choice=="n") and (current_time==24) and (am_pm=="pm")):
            print(f"{current_time} cannot be pm in 24 hour format.")
        else:
            break;
    ...
    def am_pm_function():#this function will change am to pm like if alarm greater than 12 it will change am to pm and if it is greater than 24 it will again change pm to am.
        ...
        if(current_time<12 and alarm<12 and len(conditioned_list)==0 and (alarm_time>=12 and alarm_time<=22)):
            global am_pm
        ...
        elif(current_time==23 and alarm<12 and len(conditioned_list)==0 and alarm_time<=34):
